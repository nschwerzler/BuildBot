...
def generate():
    ...
    # Thin flat knuckle guard plate facing forward (vertical wall at the end)
    last_y = profiles[-1][0]
    hand_rx = 40   # matches hand width
    hand_rz = 22   # matches hand height
    plate_thick = 3.0   # thin
    box(m,
        -hand_rx - 5,   last_y,   -hand_rz - 5,      # x0, y0, z0
         hand_rx + 5,   last_y + plate_thick,   hand_rz + 10)  # x1, y1, z1
